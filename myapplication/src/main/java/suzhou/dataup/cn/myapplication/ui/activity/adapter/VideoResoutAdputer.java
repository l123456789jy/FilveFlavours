 ...
 * 安卓的适配器
 */
public class VideoResoutAdputer extends RecyclerView.Adapter<VideoResoutAdputer.ItemViewHolder> {
    //区分显示不同的条目
    private static final int IS_HEADER = 2;
    private static final int IS_FOOTER = 3;
    private static final int IS_NORMAL = 1;
    public List<VideoBean.ResultsEntity> resultsEntityList;
    public DisplayImageOptions options_base;
    public LayoutUtil layoutUtil;
    String tempTime = "first";
    boolean isFirst = true;

    public VideoResoutAdputer(List<VideoBean.ResultsEntity> resultsEntityList, DisplayImageOptions options_base, LayoutUtil layoutUtil) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == IS_FOOTER) {
            ...
            view = View.inflate(parent.getContext(), R.layout.fragment_video_item, null);
        }
    ...
    public void onBindViewHolder(ItemViewHolder viewHolder, int position) {
        ...
        if (itemViewType != IS_FOOTER) {
            ...
            layoutUtil.drawViewLayout(viewHolder.mRl, 1f, 0f, 0.086f, 0f);
    ...
    public static class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(View itemView, int viewType) {
            ...
            if (viewType != IS_FOOTER) {
                ...
                mVideo = (ImageView) itemView.findViewById(R.id.video_iv);
            } else {
